          ...
          <SimpleGrid columns={{base:1, lg:2}} spacing={10}>
            ...
            >
              <Box borderRadius="lg" overflow="hidden" pt={{base:6}}>
                <Box textDecoration="none" _hover={{ textDecoration: 'none' }} maxH={{lg:'35vh'}}>
                    <NextLink href="/research-and-dev/tax-credits" passHref>
                      <Illustration2 />
                      {/* <Illustration height={{ sm: '24rem', lg: '30vh' }} mt={{ base: 12, sm: 16, md:0 }} mb={{lg: 5}} /> */}
                  </NextLink>
                </Box>
              </Box>
            ...
            >
              <Box borderRadius="lg" overflow="hidden">
                <Box textDecoration="none" _hover={{ textDecoration: 'none' }} maxH={'60vh'}>
